    ...
    <ul class="menu">
        <li class="first"><a href="{fetch( 'content', 'node', hash( 'node_id', ezini( 'SBSettings', 'VideosNode', 'web.ini' ) )).url_alias|ezurl(no)}">Vídeos</a></li>
        <li><a href="{fetch( 'content', 'node', hash( 'node_id', ezini( 'SBSettings', 'LinksNode', 'web.ini' ) )).url_alias|ezurl(no)}">Directorio de Enlaces</a></li>
